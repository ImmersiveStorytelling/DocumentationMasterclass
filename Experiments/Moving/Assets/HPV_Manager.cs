...
public class HPV_Unity_Bridge
{
    ...
    /// </summary>	
    [DllImport("HPV_Unity_Bridge", CallingConvention = CallingConvention.Cdecl)]
    public static extern void SetTexPtr(byte hpv_node_id, System.IntPtr tex);
...
public class HPV_Manager : MonoBehaviour
{
    ...
    public int getCurrentFrameNum(byte node_id)
    {
        return HPV_Unity_Bridge.GetCurrentFrameNum(node_id);
    }
}